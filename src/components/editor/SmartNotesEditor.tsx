...
const createNotesTheme = (font: string, size: string, lineHeight: string = 'standard') => {
    ...
    return EditorView.theme({
        ...
        ".cm-hl-r": { color: "#EF4444 !important", border: "1px solid #CCCCCC !important" },
        ".cm-hl-b": { color: "#3B82F6 !important", border: "1px solid #CCCCCC !important" },
        ".cm-hl-g": { color: "#22C55E !important", border: "1px solid #CCCCCC !important" },
        ".cm-custom-tr": { position: "relative", backgroundColor: "#3B82F644 !important", color: "#3B82F6 !important", border: "1px solid #CCCCCC !important", padding: "0 2px", cursor: "help", borderRadius: "4px !important" },
        ".dark & .cm-custom-tr": { backgroundColor: "#3B82F633 !important", color: "#60A5FA !important", border: "1px solid #CCCCCC !important", borderRadius: "4px !important" },
        ...
        ".cm-custom-mk-ins":  { backgroundColor: "#EDE9FE !important", color: "#6D28D9 !important", border: "1px solid #CCCCCC !important", padding: "0 3px", borderRadius: "4px !important" },
        ".cm-custom-mk-idea": { backgroundColor: "#B91C1C !important", color: "#ffffff !important", border: "1px solid #CCCCCC !important", padding: "0 3px", borderRadius: "4px !important" },
        ".cm-custom-mk-op":   { backgroundColor: "#ECFCCB !important", color: "#3F6212 !important", border: "1px solid #CCCCCC !important", padding: "0 3px", borderRadius: "4px !important" },
        ".cm-custom-mk-duda": { backgroundColor: "#E0F2FE !important", color: "#0369A1 !important", border: "1px solid #CCCCCC !important", padding: "0 3px", borderRadius: "4px !important" },
        ".cm-custom-mk-wow":  { backgroundColor: "#FCE7F3 !important", color: "#9D174D !important", border: "1px solid #CCCCCC !important", padding: "0 3px", borderRadius: "4px !important" },
        ".cm-custom-mk-pat":  { backgroundColor: "#F3E8FF !important", color: "#6B21A8 !important", border: "1px solid #CCCCCC !important", padding: "0 3px", borderRadius: "4px !important" },
        ".cm-custom-mk-yo":   { backgroundColor: "#FEF3C7 !important", color: "#92400E !important", border: "1px solid #CCCCCC !important", padding: "0 3px", borderRadius: "4px !important" },
        ".cm-custom-mk-ruido":{ backgroundColor: "#F3F4F6 !important", color: "#374151 !important", border: "1px solid #CCCCCC !important", padding: "0 3px", borderRadius: "4px !important" },
        ".cm-custom-mk-contra":{ backgroundColor: "#FEE2E2 !important", color: "#991B1B !important", border: "1px solid #CCCCCC !important", padding: "0 3px", borderRadius: "4px !important" },

        // DARK MODE - fondos sólidos oscuros
        ".dark & .cm-custom-mk-ins":  { backgroundColor: "#2E1065 !important", color: "#C4B5FD !important", border: "1px solid #CCCCCC !important" },
        ".dark & .cm-custom-mk-idea": { backgroundColor: "#450A0A !important", color: "#FCA5A5 !important", border: "1px solid #CCCCCC !important" },
        ".dark & .cm-custom-mk-op":   { backgroundColor: "#1A2E05 !important", color: "#BEF264 !important", border: "1px solid #CCCCCC !important" },
        ".dark & .cm-custom-mk-duda": { backgroundColor: "#082F49 !important", color: "#7DD3FC !important", border: "1px solid #CCCCCC !important" },
        ".dark & .cm-custom-mk-wow":  { backgroundColor: "#500724 !important", color: "#F9A8D4 !important", border: "1px solid #CCCCCC !important" },
        ".dark & .cm-custom-mk-pat":  { backgroundColor: "#3B0764 !important", color: "#D8B4FE !important", border: "1px solid #CCCCCC !important" },
        ".dark & .cm-custom-mk-yo":   { backgroundColor: "#451A03 !important", color: "#FCD34D !important", border: "1px solid #CCCCCC !important" },
        ".dark & .cm-custom-mk-ruido":{ backgroundColor: "#1F2937 !important", color: "#9CA3AF !important", border: "1px solid #CCCCCC !important" },
        ".dark & .cm-custom-mk-contra":{ backgroundColor: "#450A0A !important", color: "#EF4444 !important", border: "1px solid #CCCCCC !important" },
