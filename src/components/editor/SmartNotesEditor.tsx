...
const createNotesTheme = (font: string, size: string) => {
    ...
    return EditorView.theme({
        ...
        ".cm-custom-hl": { backgroundColor: "#ccff00", color: "#000 !important", padding: "0 2px", fontWeight: "600" },
        ".dark .cm-custom-hl": { backgroundColor: "rgba(204, 255, 0, 0.3)", color: "inherit !important" },
        ".cm-custom-tr": { position: "relative", backgroundColor: "rgba(96, 165, 250, 0.9)", color: "#000 !important", padding: "0 2px", fontWeight: "600", cursor: "help" },
