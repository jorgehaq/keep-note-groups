            ...
            <div className="sticky top-0 z-30 bg-white/80 dark:bg-[#1A1A24]/90 backdrop-blur-md border-b border-zinc-200 dark:border-[#2D2D42] shadow-sm shrink-0">
                <div className="h-[72px] flex items-center justify-between px-4 md:px-6 py-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {/* TABS EN EL HEADER */}
                        <div className="h-9 hidden md:flex bg-zinc-100 dark:bg-black/40 p-1 rounded-xl border border-zinc-200 dark:border-[#3F3F46] shrink-0">
                            {TABS.map((tab) => (
                                <button
                                    key={tab.key}
                ...
                <div className="flex md:hidden px-4 pb-3">
                    <div className="flex bg-zinc-100 dark:bg-black/40 p-1 rounded-xl w-full border border-zinc-200 dark:border-[#3F3F46]">
                        {TABS.map((tab) => (
                            <button
                                key={tab.key}
                                onClick={() => setActiveTab(tab.key)}
