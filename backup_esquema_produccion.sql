...
CREATE POLICY "Users can manage summaries of their brain_dumps" ON "public"."summaries" TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."notes"
  WHERE (("notes"."id" = "summaries"."note_id") AND ("notes"."user_id" = "auth"."uid"())))) OR (EXISTS ( SELECT 1
   FROM "public"."brain_dumps"
  WHERE (("brain_dumps"."id" = "summaries"."brain_dump_id") AND ("brain_dumps"."user_id" = "auth"."uid"())))))) WITH CHECK (((EXISTS ( SELECT 1
   FROM "public"."notes"
  WHERE (("notes"."id" = "summaries"."note_id") AND ("notes"."user_id" = "auth"."uid"())))) OR (EXISTS ( SELECT 1
   FROM "public"."brain_dumps"
