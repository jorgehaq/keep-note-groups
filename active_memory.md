...
- 2026-03-24: Rediseño Premium de Interfaz de Notas: Implementado sistema de pestañas (Tray) con auto-scroll a la nota activa; estandarizada toolbar de utilidades con diseño de fondo suave y fuente medium; duplicado el padding interno de editores para mayor legibilidad; unificada la orientación del Pizarrón (Vertical/Horizontal) persistida en UIStore.
- 2026-03-24: Estandarización de Diseño Premium (Botones & UI): Implementada nueva filosofía de botones (`rounded-xl` + `active:scale-95`) en toda la app; unificado el estilo "Tinted" para estados activos (no más fondos sólidos); estandarizado ritmo vertical a 20px entre bloques principales.
- 2026-03-24: Refactorización Visual de Group Launcher y Tarjetas: Convertida la lista de grupos en un grid de tarjetas premium; unificado el hover/borde de tarjetas en el dashboard y el archivo; habilitada herencia de color de iconos para estados de hover dinámicos.
